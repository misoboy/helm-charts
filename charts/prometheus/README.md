...
Fork [prometheus-community](https://github.com/prometheus-community/helm-charts/)
...
- Alert Manager: v0.23.0
- Node Exporter: v1.3.0
- Push Gateway: v1.4.2
- Prometheus Server: v2.31.1
...
See [Default Prometheus Chart Commands](https://github.com/helm/charts/blob/master/stable/prometheus/README.md#configuration)

### Additional Commands
Parameter | Description | Default
--------- | ----------- | -------
`server.federation` | If true, Prometheus Federation Server 용으로 사용 | `false`
...
```console
helm install [RELEASE_NAME] -f values.yaml -f service1-alert.yaml -f service2-alert.yaml ./
```
